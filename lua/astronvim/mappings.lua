...
--TODO these are only two function commented if you want to uncommment these you have to uncomment from line:61 to line:68
--maps.n[">b"] = {
...
--}
maps.n[";;"] = { function() vim.cmd("e #") end, desc = "Switch to Other Buffer" }



--maps.n["<leader>b"] = sections.b
--maps.n["<leader>bc"] ={ function() require("astronvim.utils.buffer").close_all(true) end, desc = "Close all buffers except current" }
--maps.n["<leader>bC"] = { function() require("astronvim.utils.buffer").close_all() end, desc = "Close all buffers" }
--maps.n["<leader>bl"] ={ function() require("astronvim.utils.buffer").close_left() end, desc = "Close all buffers to the left" }
--maps.n["<leader>bp"] = { function() require("astronvim.utils.buffer").prev() end, desc = "Previous buffer" }
--maps.n["<leader>br"] ={ function() require("astronvim.utils.buffer").close_right() end, desc = "Close all buffers to the right" }
...
-- Alpha
--TODO if you want to enble this uncomment line from 127 tot 138
...
if is_available "neo-tree.nvim" then
  maps.n["<C-a>"] = { "<cmd>Neotree toggle<cr>", desc = "Toggle Explorer" }
  maps.n["<C-x>"] = {
    function()
...
if is_available "telescope.nvim" then
   ...
   --maps.n["<leader>g"] = sections.g
  -- maps.n["<leader>gb"] ={ function() require("telescope.builtin").git_branches { use_file_path = true } end, desc = "Git branches" }
  -- maps.n["<leader>gc"] = {function() require("telescope.builtin").git_commits { use_file_path = true } end,desc = "Git commits (repository)",}
  -- maps.n["<leader>gC"] = {function() require("telescope.builtin").git_bcommits { use_file_path = true } end, desc = "Git commits (current file)", }
  -- maps.n["<leader>gt"] = { function() require("telescope.builtin").git_status { use_file_path = true } end, desc = "Git status" }
  -- maps.n["<leader>f<CR>"] = { function() require("telescope.builtin").resume() end, desc = "Resume previous search" }
  -- maps.n["<leader>f'"] = { function() require("telescope.builtin").marks() end, desc = "Find marks" }
  -- maps.n["<leader>f/"] = { function() require("telescope.builtin").current_buffer_fuzzy_find() end, desc = "Find words in current buffer" }
  ...
  maps.n["<leader><leader>"] = { function() require("telescope.builtin").buffers() end, desc = "Find buffers" }
  maps.n["<leader>fc"] = { function() require("telescope.builtin").grep_string() end, desc = "Find word under cursor" }
  --maps.n["<leader>fC"] = { function() require("telescope.builtin").commands() end, desc = "Find commands" }
  maps.n["[["] = { function() require("telescope.builtin").find_files() end, desc = "Find files" }
  maps.n[";f"] = {
 ...
 -- maps.n["<leader>fo"] = { function() require("telescope.builtin").oldfiles() end, desc = "Find history" }
  ...
  maps.n[";r"] = { function() require("telescope.builtin").live_grep() end, desc = "Find words" }
...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<C-`>"] = { "<cmd>ToggleTerm size=10 direction=horizontal<cr>", desc = "ToggleTerm horizontal split" }
